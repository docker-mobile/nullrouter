...
<head>
  ...
  <title>nullrouter - One Endpoint for All AI Providers</title>
...
<body class="nr-top-page nr-landing-page">
  <header class="nr-top-nav">
    <a class="nr-top-brand" href="/landing" aria-label="nullrouter landing">
      <span class="nr-logo-mark">nr</span>
      <span>nullrouter</span>
    </a>
    <nav>
  ...
  <main>
    <section class="nr-landing-hero">
      <div class="nr-hero-copy">
        ...
        <div class="nr-hero-actions">
          ...
          <a class="nr-button nr-button-secondary" href="/dashboard">Open Dashboard</a>
        </div>
      </div>
      <div class="nr-hero-panel" aria-label="Route flow">
        ...
        <div class="nr-flow-row nr-flow-row-active"><span>nullrouter</span><strong>20128</strong></div>
        <div class="nr-flow-line"></div>
    ...
    <section class="nr-top-band" id="get-started">
      <div>
        ...
        <p>Install nullrouter, open the dashboard, configure providers, and point your tools to the local endpoint.</p>
        <ol class="nr-steps">
          <li><strong>Start nullrouter</strong><span>Run ./run.sh to bring up every service.</span></li>
      ...
      <pre class="nr-terminal"><code>$ ./run.sh
&gt; Starting nullrouter...
...
&gt; Ready to route.</code></pre>
    ...
    <section class="nr-top-band nr-how" id="how-it-works">
      ...
      <div class="nr-feature-grid nr-feature-grid-three">
        ...
        <article><span class="nr-card-icon">nr</span><h3>nullrouter</h3><p>The local router selects configured providers and keeps one endpoint stable.</p></article>
    ...
    <section class="nr-top-band" id="features">
      ...
      <div class="nr-feature-grid">
        ...
        <article><span class="nr-card-icon">WEB</span><h3>Dashboard</h3><p>Use the web interface for providers, keys, usage, and routing state.</p></article>
      </div>
    </section>
  </main>
</body>
